...
// No PROJECTION_NAME export — inline projections don't use bookmarks.
// No waitUntilProcessed — the read model is consistent the instant append returns.

export class Api {
    private readModelRepository: ReturnType<typeof PongoCourseSubscriptionsRepository>

    constructor(
        private pool: Pool,
        private eventStore: EventStore
    ) {
        this.readModelRepository = PongoCourseSubscriptionsRepository(pool)
    }
